...
app.post('/', express.json(), async (req, res) => {
    ...
    try {
        ...
        const selectors = {
            ...
            "new_selector_1": "div > div.update-components-actor.display-flex.update-components-actor--with-control-menu > a > div.update-components-actor__image.relative > span > div > div > img",
